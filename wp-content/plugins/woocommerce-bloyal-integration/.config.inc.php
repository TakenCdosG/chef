...
define('BLOYAL_API_KEY', 'PHLUVWKNCO-PTXOKCEIHL'); // <API Key - Provided by client> This is provided by the client and scopes access into their account.
...
define('BLOYAL_ACCESS_KEY', '7c893d7dcc082a904238466a908cdd0b0cabe94ca25d78b4f41d67fba2b1f6adb716437282bf2de9c636942a'); //'fc434ba4c64e32675f53b1b6f3c64dc4f86aca3c7fad6c35cafc1115b3dfdcbf2ec97442b7ee689bd475458b'); // ApiDemo key.  Go ahead and use for internal API evaluation.
define('BLOYAL_STORECODE', 'Web'); //<Your Client Login Domain>
define('BLOYAL_INVENTORY_TRANSACTION', 'INVLOCAT1'); //<Your Client Login Domain> 'SANDBOX'

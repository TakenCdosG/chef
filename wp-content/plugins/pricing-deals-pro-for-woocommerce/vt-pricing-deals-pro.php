...
class VTPRD_Pro_Controller{
    ...
    define('VTPRD_PRO_VERSION',                           '1.1.6.7');  //in the FREE version, current required version remains 1.1.2 ...     
    define('VTPRD_PRO_MINIMUM_REQUIRED_FREE_VERSION',     '1.1.6.7');  //required version of
    define('VTPRD_PRO_LAST_UPDATE_DATE',                  '2016-07-18');
